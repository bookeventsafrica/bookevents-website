    ...
    return <>
        ...
        <section className="px-[2rem] lg:px-[6.18rem] bg-[#fff] py-[50px]  flex justify-center">
            <div className="flex gap-[38px] flex-col lg:flex-row">
                ...
                <div className="flex-1">
                    <Image src='/img/event.png' width={455} height={426} alt="Book Event Team Providing Event support" className="w-full lg:w-[455px]"     placeholder="blur"/>
                </div>
            </div>
                ...
                <div className="flex gap-[32px] flex-wrap">
                    <div className="w-full lg:w-[250px] bg-secondary-500 shadow-lg px-[18px] py-[36px] rounded-[4px] flex flex-col items-center">
                        <div className="flex-1 mb-[18px]">
                            <Image src={'/img/support.png'} width={200} height={126} alt='Book Event Africa Event Support' className="h-[126px] object-contain"    placeholder="blur" />
                        </div>
                    ...
                    <div className="w-full lg:w-[250px] bg-primary-500 shadow-lg px-[18px] py-[36px] rounded-[4px] flex flex-col items-center">
                        <div className="flex-1  mb-[18px]">
                            <Image src={'/img/promotions.png'} width={200} height={126} alt='Book Event Africa Event Promotions' className="h-[126px] object-contain"    placeholder="blur"/>
                        </div>
                        <div className="text-center !text-white">
                    ...
                    <div className="w-full lg:w-[250px] bg-tertiary-500 shadow-lg px-[18px] py-[36px] rounded-[4px] flex flex-col items-center">
                        <div className="flex-.8  mb-[18px]">
                            <Image src={'/img/ticket.png'} width={200} height={126} alt='Book Event Africa Ticket Sales' className="h-[126px] object-contain"    placeholder="blur"/>
                        </div>
                        <div className="text-center !text-white">
                            <h4 className="text-[16px] font-bold text-[#292D32]  mb-[21px]">
                                Ticket Sales
                    ...
                    <div className="w-full lg:w-[250px] bg-primary-100 shadow-lg px-[18px] py-[36px] rounded-[4px] flex flex-col items-center">
                        <div className="flex-1 mb-[18px]">
                            ...
                            <Image src={'/img/manage.png'} width={200} height={126} alt='Book Event Africa Event Management' className="h-[126px] object-contain"    placeholder="blur"/>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-[48px]">
                    <div className="w-full lg:w-[274px] bg-white  rounded-[4px] cursor-pointer">
                        <Image loading={'lazy'} src={'/img/cto.png'} className="w-full rounded-t-[4px]" alt="" width={274} height={100}    placeholder="blur"  />
                    ...
                    <div className="w-full lg:w-[274px] bg-white  rounded-[4px] cursor-pointer">
                        <Image loading={'lazy'} src={'/img/co-founder.jpg'} className="w-full rounded-t-[4px] h-[276px] object-cover" alt="" width={274} height={100}    placeholder="blur" />
                        <div className="text-center mt-[9px] pb-[20px]">
                    ...
                    <div className="w-full lg:w-[274px] bg-white  rounded-[4px] cursor-pointer">
                        <Image loading={'lazy'} src={'/img/bea-ui-ux.png'} className="w-full rounded-t-[4px]" alt="" width={274} height={100}    placeholder="blur"/>
                        <div className="text-center mt-[9px] pb-[20px]">
                    ...
                    <div className="w-full lg:w-[274px] bg-white  rounded-[4px] cursor-pointer">
                        <Image loading={'lazy'} src={'/img/hr.png'} className="w-full rounded-t-[4px]" alt="" width={274} height={100}    placeholder="blur" />
                        <div className="text-center mt-[9px] pb-[20px]">
                    ...
                    <div className="w-full lg:w-[274px] bg-white  rounded-[4px] cursor-pointer">
                        <Image loading={'lazy'} src={'/img/legal.jpg'} className="w-full rounded-t-[4px] h-[276px] object-cover" alt="" width={274} height={100}    placeholder="blur" />
                        <div className="text-center mt-[9px] pb-[20px]">
                    ...
                    <div className="w-full lg:w-[274px] bg-white  rounded-[4px] cursor-pointer">
                        <Image loading={'lazy'} src={'/img/socials.jpg'} className="w-full rounded-t-[4px] h-[276px] object-cover" alt="" width={274} height={100}    placeholder="blur"/>
                        <div className="text-center mt-[9px] pb-[20px]">
